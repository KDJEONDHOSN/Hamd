...
if UserID == 2034770645 or UserID == 1619524486then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد الشيخ فواز \n") end
...
msg = arg.msg
if UserID == 2034770645 or UserID == 1619524486then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد الشيخ فواز ") end
NameUser = Hyper_Link_Name(data)
...
local text = " [الشيخ فواز🌐 ](t.me/wtttw)"
local inline = {
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/KDJEONDHOSN/Hamd/main/plugins/"..FileName)
if res == 200 then
...
NameUser = Hyper_Link_Name(data)
if UserID == 2034770645 or UserID == 1619524486then 
...
if msg.adduser == 2034770645 or msg.adduser ==  1619524486 then 
gtupe = 'الشيخ فواز' 
...
return sendMsg(msg.chat_id_,msg.id_,"اعقب ما ابوس انا ذي فيها علوم الرجاجيل!")
end 
...
elseif Text== "باسل" or Text== "بيسو" or Text== "بسله" then return sendMsg(msg.chat_id_,msg.id_,"[الشيخ فواز👑](T.ME/wtttw)")
