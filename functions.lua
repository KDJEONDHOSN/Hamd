...
if edit then EditMsg(msg.chat_id_,msg.id_,'10% - |█    @wtttw     |') end
if edit then EditMsg(msg.chat_id_,msg.id_,'20% - |███  @wtttw       |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/Hamd/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████  @wtttw     |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/Hamd/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████  @wtttw   |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/Hamd/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████ @wtttw  |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/Hamd/main/inc/functions.lua','./inc/functions.lua')
